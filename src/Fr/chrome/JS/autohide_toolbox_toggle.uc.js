// ==UserScript==
// @name           Masquages des barres d'outils
// @include        main
// ==/UserScript==
...
(() => {
  ...
  const VERSION = "1.0";
  const LABEL_BASE = "Masquages des barres d'outils";
  ...
  function updateButtonNode(button, enabled) {
    ...
    const tooltip = enabled
      ? "Masquage actif — cliquer pour garder les barres affichées"
      : "Barres affichées — cliquer pour activer le masquage";
  ...
  function createToolbarButton() {
    ...
    CustomizableUI.createWidget({
      ...
      onBuild(doc) {
        ...
        button.setAttribute("label", LABEL_BASE);
        button.setAttribute("tooltiptext", "Basculer barres fixes / Masquage automatique");
  ...
  function init() {
    ...
    try {
      ...
      console.error("Erreur création bouton Masquages des barres d'outils :", error);
    }
